...
- [ ] Confirm which PVT corner(s) the design must be verified against before synthesis.
- [ ] Decide whether hierarchical or flattened synthesis better suits the current design stage.
- [ ] Use submodule-level synthesis to validate complex blocks before full-design integration.
- [ ] Insert flip-flops between combinational stages where glitches could be captured by downstream logic.
- [ ] Ensure combinational logic settles well before the active clock edge.
